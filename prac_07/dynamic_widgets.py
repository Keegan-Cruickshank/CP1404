...
class DynamicWidgetsApp(App):
    ...
    def create_widgets(self):
        ...
        for name in self.phonebook:
            # create a button for each phonebook entry, specifying
            # the text and id (although text and id are the same in
            # this case, you should see how this works)
    ...
    def clear_all(self):
        """
        Clear all of the widgets that are children
        of the "entries_box" layout widget
        :return:
        """
